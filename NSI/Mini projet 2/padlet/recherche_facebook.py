...
def recherche_facebook(nom_recherche, filtre, driver):
    ...
    while len(items) < filtre["nbArticles"]:
        ...
        items = [i for i in items if i.find("div",{"class":"_59k _2rgt _1j-f _2rgt"}).text != "GRATUIT"]
        
        items = [i for i in items if int(i.find("div",{"class":"_59k _2rgt _1j-f _2rgt"}).text[0:-2]) < filtre["prixMax"] and
    ...
    for i in items:
        ...
        prix = i.find("div",{"class":"_59k _2rgt _1j-f _2rgt"}).text[0:-2]
