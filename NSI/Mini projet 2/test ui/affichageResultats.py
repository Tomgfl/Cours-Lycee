...
def affiche(tri):
    ...
    Label(master, image = img).grid(row = 0, column = 0,columnspan = 2, rowspan = 1, padx = 5, pady = 5)
    # Ajout du nom à la fenetre master et ancrage de celui ci
    Label(master, text = art.nom).grid(row = 1, column = 0, columnspan = 2, padx = 5, pady = 5)
    # Ajout du prix à la fenetre master et ancrage de celui ci
    Label(master, text = str(art.prix)+" €").grid(row = 2, column = 0, padx = 5, pady = 5)
    ...
    if ID != len(tri) - 1 :
        ...
        suivant = Label(master, text="  Suivant", cursor="hand2", relief=RAISED)
        # Ancrage de celui ci
    ...
    if ID != 0 :
        ...
        precedent = Label(master, text="  Précédent", cursor="hand2", relief=RAISED)
        # Ancrage de celui ci
