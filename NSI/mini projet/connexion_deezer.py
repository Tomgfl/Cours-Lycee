...
def creation_playlist(dz,client,playlist,name):

    # Creation de la playlist 
    playlist_create = requests.post(f"https://api.deezer.com/user/me/playlists?title={name}&access_token={dz.access_token}")
...
creation_playlist(dz,client,a_convertir,"voiture")
#print(a_convertir)
